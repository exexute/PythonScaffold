...
class SeBug (threading.Thread):
	def __init__(self, s, l):
		...
		self.s = s
		self.num = l
		self.headers = {"User-Agent":"Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_1) AppleWebKit/601.2.7 (KHTML, like Gecko) Version/9.0.1 Safari/601.2.7"}
...
def load_pagecount():
	r = requests.get(url = "https://www.seebug.org/vuldb/vulnerabilities", headers = headers)
